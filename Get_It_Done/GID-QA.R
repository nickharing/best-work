...
##        All data exploration below line 72 uses, 2016-2019_GID-data_subsampled.csv, which is attached to the email. Just place file into your working dir folder and go from there. feel free to contact me if these are any problems: 619.995.0508
...
###--------
# START HERE with "2016-2019_GID-data_subsampled.csv"

mini_file <- "2016-2019_GID-data_subsampled.csv"
